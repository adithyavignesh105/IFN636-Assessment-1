...
describe('Item Controller Tests', () => {
  ...
  describe('addItem', () => {
    it('should create a new item successfully with image and deadline', async () => {
    ...
    it('should return 500 on error', async () => {
      ...
      const req = { user: { id: new mongoose.Types.ObjectId() }, body: {}, file: null };
      const res = { status: sinon.stub().returnsThis(), json: sinon.spy() };
  ...
  describe('updateItem', () => {
    it('should update item with new values including image and deadline', async () => {
      const fakeUserId = new mongoose.Types.ObjectId().toString();
      const fakeItem = {
        _id: new mongoose.Types.ObjectId(),
        userId: fakeUserId,
